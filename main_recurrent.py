...
if __name__ == "__main__":
    ...
    loss_curve_gru = run_experiment("GRU", GRU, X_train, y_train, X_test, y_test, test_labels, hidden_size, batch_size)
    ...
    plt.plot(range(len(loss_curve_gru)), loss_curve_gru.get(), label="GRU")
